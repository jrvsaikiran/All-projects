...
public class FourthCase {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// System.out.println(otpField);
		
		if (otp.contains("otp field is required."))
		{
			
			System.out.println("'OTP Field Is Required' is displayed");
			
		}
		else {
			System.out.println("'OTP Field Is Required' is not displayed");
		}
